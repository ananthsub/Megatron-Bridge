...
from megatron.bridge.recipes.mamba.mamba2_1_3b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, MambaProvider1_3B)
    ...
    def test_model_config_all_custom_parameters(self):
        ...
        config = model_config(
            tensor_parallelism=1,  # Mamba 1.3B has only 1 attention head
