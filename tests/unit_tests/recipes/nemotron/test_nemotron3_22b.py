...
@pytest.mark.unit
class TestNemotron3_22BModelConfig:
    """Test cases for the Nemotron3 22B model_config function."""

    def test_model_config_default_parameters(self):
        """Test model_config with default parameters."""
        config = model_config()

        assert isinstance(config, Nemotron3ModelProvider22B)
...
@pytest.mark.unit
class TestNemotron3_22BPretrainConfig:
    """Test cases for the Nemotron3 22B pretrain_config function."""
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Nemotron3ModelProvider22B)

        # Check Nemotron3 22B specific defaults
