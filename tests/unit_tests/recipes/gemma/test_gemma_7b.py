...
from megatron.bridge.models.gemma import GemmaModelProvider7B
from megatron.bridge.recipes.gemma.gemma_7b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, GemmaModelProvider7B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, GemmaModelProvider7B)
    ...
    def test_pretrain_config_default_comm_overlap(self):
        ...
        # Default setup should have TP comm overlap disabled for 7B model with TP=2
