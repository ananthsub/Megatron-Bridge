...
from megatron.bridge.models.gemma import Gemma2ModelProvider2B
from megatron.bridge.recipes.gemma.gemma2_2b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Gemma2ModelProvider2B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Gemma2ModelProvider2B)
    ...
    def test_pretrain_config_default_comm_overlap(self):
        ...
        # Default setup should have TP comm overlap disabled for 2B model with TP=2
