...
from megatron.bridge.models.gemma import Gemma2ModelProvider9B
from megatron.bridge.recipes.gemma.gemma2_9b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Gemma2ModelProvider9B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Gemma2ModelProvider9B)
    ...
    def test_pretrain_config_default_comm_overlap(self):
        ...
        # Default setup should have TP comm overlap disabled for 9B model with TP=8
