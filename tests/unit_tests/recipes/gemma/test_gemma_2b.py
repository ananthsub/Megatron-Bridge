...
from megatron.bridge.models.gemma import GemmaModelProvider2B
from megatron.bridge.recipes.gemma.gemma_2b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, GemmaModelProvider2B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, GemmaModelProvider2B)
    ...
    def test_pretrain_config_default_comm_overlap(self):
        ...
        # Default setup should have TP comm overlap disabled for 2B model with TP=1
