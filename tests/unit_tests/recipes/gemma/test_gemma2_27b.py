...
from megatron.bridge.models.gemma import Gemma2ModelProvider27B
from megatron.bridge.recipes.gemma.gemma2_27b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Gemma2ModelProvider27B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Gemma2ModelProvider27B)
    ...
    def test_pretrain_config_default_comm_overlap(self):
        ...
        # Default setup should have TP comm overlap disabled for 27B model with TP=8, PP=2
