...
def model_config(
    ...
    """
    Configure the Mamba 2.7B model.
    ...
    Returns:
        MambaProvider2_7B: Configuration for the Mamba 2.7B model.
    """
    return MambaProvider2_7B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Mamba 2.7B model.
