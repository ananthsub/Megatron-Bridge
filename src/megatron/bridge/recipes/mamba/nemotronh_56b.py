...
def model_config(
    ...
    """
    Configure the NemotronH Hybrid 56B model.
    ...
    Returns:
        NemotronHModel56BProvider: Configuration for the NemotronH Hybrid 56B model.
    """
    return NemotronHModel56BProvider(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for NemotronH Hybrid 56B model.
