...
def model_config(
    ...
    """
    Configure the Mamba 370M model.
    ...
    Returns:
        MambaProvider370M: Configuration for the Mamba 370M model.
    """
    return MambaProvider370M(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Mamba 370M model.
