...
from megatron.bridge.models.mamba import NVIDIAMambaHybridProvider8B
...
def model_config(
    ...
    Returns:
        NVIDIAMambaHybridProvider8B: Configuration for the Mamba Hybrid 8B model.
    """
    return NVIDIAMambaHybridProvider8B(
