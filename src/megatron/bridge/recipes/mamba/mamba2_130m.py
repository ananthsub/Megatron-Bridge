...
def model_config(
    ...
    """
    Configure the Mamba 130M model.
    ...
    Returns:
        MambaProvider130M: Configuration for the Mamba 130M model.
    """
    return MambaProvider130M(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Mamba 130M model.
