...
def model_config(
    ...
    """
    Configure the Llama4 128-Experts (Maverick) model.
    ...
    Returns:
        Llama4Experts128ModelProvider: Configuration for the Llama4 128-Experts (Maverick) model.
    """
    return Llama4Experts128ModelProvider(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Llama4 128-Experts (Maverick) model.
    ...
    Note:
        Sequence length is set to 8192 for Llama4 128-Experts pretraining.
    """
...
def finetune_config(
    ...
    - SFT: TP=1, expert_TP=4, expert_MP=32, SP=True
    - PEFT: TP=1, expert_TP=8, PP=4, SP=True
    ...
    Examples:
        Convert and fine-tune a HuggingFace model:
            ...
            >>> bridge = AutoBridge.import_ckpt("meta-llama/Llama-4-Maverick-17B-128E-Instruct", "/path/to/checkpoint")
    ...
    Note:
        This recipe is optimized for the Llama4 128-Experts (Maverick) model with mixture-of-experts architecture.
    """
    ...
    if peft_config is None:
        # SFT: TP=1, expert_TP=4, expert_MP=32
        model_cfg = model_config(
    ...
    cfg = ConfigContainer(
        ...
        optimizer=opt_config,
        scheduler=scheduler,
        ddp=_create_ddp_config_with_performance_opts_e128(use_distributed_optimizer, peft_config),
        ...
        tokenizer=create_tokenizer_config(model_id="meta-llama/Llama-4-Maverick-17B-128E-Instruct"),
...
def _create_ddp_config_with_performance_opts_e128(
    use_distributed_optimizer: bool,
    peft_config: Optional[PEFT] = None,
) -> DistributedDataParallelConfig:
    """
    Create DDP config with performance optimizations for Llama4 128-Experts.
