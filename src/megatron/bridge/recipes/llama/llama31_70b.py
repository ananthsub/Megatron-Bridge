...
def model_config(
    ...
    """
    Configure the Llama3.1 70B model.
    ...
    Returns:
        Llama31ModelProvider70B: Configuration for the Llama3.1 70B model.
    """
    return Llama31ModelProvider70B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Llama3.1 70B model.
    ...
    Note:
        Sequence length is hardcoded to 8192 for Llama3.1 70B pretraining.
    """
    ...
    cfg = ConfigContainer(
        ...
        dataset=GPTDatasetConfig(
            ...
            eod_mask_loss=False,
            sequence_length=8192,  # Hardcoded to 8192 for Llama3.1 70B pretraining
...
def finetune_config(
    ...
    """
    Create a fine-tuning configuration for Llama3.1 70B model.
    ...
    - SFT: 4 nodes, TP=4, PP=4, VP=5, SP=True
    - PEFT: 1 node, TP=2, PP=4, VP=5, SP=True
    ...
    Args:
        ...
        num_nodes (Optional[int]): Number of nodes. If None, auto-determined (4 for full FT, 1 for PEFT).
    ...
    Examples:
        Convert and fine-tune a HuggingFace model:
            ...
            >>> bridge = AutoBridge.import_ckpt("meta-llama/Llama-3.1-70B", "/path/to/checkpoint")
    ...
    Note:
        This recipe requires substantial computational resources for the large 70B model.
    """
    ...
    cfg = ConfigContainer(
        ...
        optimizer=opt_config,
        scheduler=scheduler,
        ddp=_create_ddp_config_with_performance_opts_70b(use_distributed_optimizer, peft_config),
        ...
        tokenizer=create_tokenizer_config(model_id="meta-llama/Llama-3.1-70B"),
...
def _create_ddp_config_with_performance_opts_70b(
    use_distributed_optimizer: bool,
    peft_config: Optional[PEFT] = None,
) -> DistributedDataParallelConfig:
    """
    Create DDP config with performance optimizations for Llama3.1 70B.
