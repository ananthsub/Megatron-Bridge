...
def finetune_config(
    ...
    """
    Create a fine-tuning configuration for Llama3.1 8B model.
    ...
    The configuration is expected to run on 1 node with 8 GPUs by default.
    ...
    Examples:
        Convert and fine-tune a HuggingFace model:
            ...
            >>> bridge = AutoBridge.import_ckpt("meta-llama/Llama-3.1-8B", "/path/to/checkpoint")
    ...
    cfg = ConfigContainer(
        ...
        tokenizer=create_tokenizer_config(model_id="meta-llama/Llama-3.1-8B"),
...
def _create_ddp_config_with_performance_opts(
    ...
    """
    Create DDP config with performance optimizations for Llama3.1 8B.
