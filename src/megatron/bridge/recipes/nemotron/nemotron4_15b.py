...
def model_config(
    ...
    """
    Configure the Nemotron4 15B model.
    ...
    Returns:
        Nemotron4ModelProvider15B: Configuration for the Nemotron4 15B model.
    """
    return Nemotron4ModelProvider15B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Nemotron4 15B model.
