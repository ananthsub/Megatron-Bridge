...
def model_config(
    ...
    """
    Configure the Nemotron3 4B model.
    ...
    Returns:
        Nemotron3ModelProvider4B: Configuration for the Nemotron3 4B model.
    """
    return Nemotron3ModelProvider4B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Nemotron3 4B model.
