...
from megatron.bridge.recipes.nemotron.nemotron4_15b import pretrain_config as base_pretrain_config
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Nemotron4 15B model with 16K sequence length.

    This is a variant of the Nemotron4 15B model with extended sequence length.
    ...
    return base_pretrain_config(
        ...
        sequence_length=16384,  # Extended sequence length
