...
def model_config(
    ...
    """
    Configure the Nemotron3 8B model.
    ...
    Returns:
        Nemotron3ModelProvider8B: Configuration for the Nemotron3 8B model.
    """
    return Nemotron3ModelProvider8B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Nemotron3 8B model.
