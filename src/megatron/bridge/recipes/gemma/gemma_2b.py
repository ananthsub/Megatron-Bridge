...
def model_config(
    ...
    Returns:
        GemmaModelProvider2B: Configuration for the Gemma 2B model.
    """
    return GemmaModelProvider2B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Gemma 2B model.
