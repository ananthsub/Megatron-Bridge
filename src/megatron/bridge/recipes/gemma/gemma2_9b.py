...
def model_config(
    ...
    """
    Configure the Gemma2 9B model.

    The default configuration is expected to run on 1 node with 8 GPUs.
    ...
    Returns:
        Gemma2ModelProvider9B: Configuration for the Gemma 9B model.
    """
