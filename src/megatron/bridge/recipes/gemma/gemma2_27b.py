...
def model_config(
    ...
    """
    Configure the Gemma2 27B model.

    This configuration is expected to run on 2 nodes with 8 GPUs each.
    ...
    Returns:
        Gemma2ModelProvider27B: Configuration for the Gemma 27B model.
    """
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Gemma2 9B model.
    Args:
