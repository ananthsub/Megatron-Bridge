...
def model_config(
    ...
    Returns:
        GemmaModelProvider7B: Configuration for the Gemma 2B model.
    """
    return GemmaModelProvider7B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Gemma 7B model.
